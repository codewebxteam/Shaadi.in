...
const PersonalProfile = () => {
  ...
  return (
    // 🔥 Remove pb-20 to fix footer gap
    <div className="min-h-screen bg-gradient-to-b from-[#fff0f5] via-white to-[#ffe4e6] font-sans relative overflow-x-hidden">
      ...
      {/* ================= NAVBAR (WITH LOGIN VIBE) ================= */}
      <nav className="bg-rose-50/90 backdrop-blur-md border-b border-rose-100 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 text-green-600 bg-green-50/80 px-4 py-1.5 rounded-full border border-green-200 shadow-sm backdrop-blur-sm">
              <ShieldCheck size={16} />
            ...
            {/* 🔥 PROFILE ICON (SHOWS USER IS LOGGED IN) */}
            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-full border border-rose-200 shadow-sm cursor-pointer hover:bg-rose-50 transition-colors">
              <div className="w-7 h-7 rounded-full bg-gradient-to-r from-[#ed2c5b] to-[#c0163e] flex items-center justify-center text-white">
                <User size={14} />
              </div>
            ...
            <div className="relative group w-36 h-36 shrink-0 rounded-2xl border-4 border-rose-100 hover:border-[#e02c5a]/50 transition-colors bg-rose-50 flex items-center justify-center overflow-hidden shadow-sm">
              {profileImage ? (
                <img
                  ...
                  // Final photo par zoom & drag value apply nahi hoga yahan,
                  // par hum directly cropped version save kar sakte the.
                  // Visually yahan user ko updated pic dikhegi.
                />
              ) : (
      ...
      <footer className="bg-white/90 backdrop-blur-md border-t border-rose-100 pt-16 pb-8 mt-10 relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="pt-6 border-t border-rose-100 flex flex-col md:flex-row items-center justify-between gap-4">
